/* VM library: aarch64 definitions, to be included from both C and assembly.
...
/* How to introduce comments in assembly on aarch64, at any point within the
   line. */
...
#define _JITTER_ASM_DEBUGGING_NOP(integer_literal_as_string)  \
  "add x31, x31, #" integer_literal_as_string
