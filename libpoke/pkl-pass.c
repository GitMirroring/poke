               ...
               int flags, int level)
{
  ...
  switch (PKL_AST_CODE (node))
    ...
    case PKL_AST_STRUCT_TYPE_FIELD:
      ...
      if (PKL_AST_STRUCT_TYPE_FIELD_OPTCOND_PRE (node))
        PKL_PASS (PKL_AST_STRUCT_TYPE_FIELD_OPTCOND_PRE (node));
      if (PKL_AST_STRUCT_TYPE_FIELD_OPTCOND_POST (node))
        PKL_PASS (PKL_AST_STRUCT_TYPE_FIELD_OPTCOND_POST (node));
