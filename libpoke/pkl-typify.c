...
struct pkl_phase pkl_phase_typify1 =
  {
   ...
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FNEG, pkl_typify1_ps_op_fneg),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FEQ, pkl_typify1_ps_op_frela),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FNE, pkl_typify1_ps_op_frela),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FLT, pkl_typify1_ps_op_frela),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FGT, pkl_typify1_ps_op_frela),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FLE, pkl_typify1_ps_op_frela),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FGE, pkl_typify1_ps_op_frela),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FADD, pkl_typify1_ps_fbin),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FSUB, pkl_typify1_ps_fbin),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FMUL, pkl_typify1_ps_fbin),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FPOW, pkl_typify1_ps_fbin),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FDIV, pkl_typify1_ps_fbin),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FCEILDIV, pkl_typify1_ps_fbin),
   PKL_PHASE_PS_OP_HANDLER (PKL_AST_OP_FMOD, pkl_typify1_ps_fbin),
